...
map.getView().fit([8350086.889784, 650413.454443, 9026765.675208, 1112704.592464], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Test Map</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (76 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This web map shows the main transportation routes and waterways in Sri Lanka';
            }
